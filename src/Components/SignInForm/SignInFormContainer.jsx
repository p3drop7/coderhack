                ...
                { (form === 1) &&
                    <form action="#" className="access_form">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" placeholder="Ingrese su email" pattern="^[a-z0-9]+(.[_a-z0-9]+)@[a-z0-9-]+(.[a-z0-9-]+)(.[a-z]{2,15})$" required></input>
                        </div>
                        
                        <div>
                            <label for="password">Contraseña</label>
                            <input type="password" name="password" placeholder="Ingrese su contraseña" requiered></input>
                        </div>
                ...
                { (form === 2) &&
                    <form action="#" className="signIn_form">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" placeholder="Ingrese su nombre" requiered></input>
                        </div>
                       ...
                       <div className="access_submit-btn"><Link className="react-link" to="/app/choice">Ingresar</Link></div>
